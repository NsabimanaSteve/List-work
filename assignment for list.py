...
# Example usage:
my_list = [1, 2, 2, 3, 4, 5]
print(my_count(my_list, 2))  # Should print 2
print(my_in(my_list, 4))  # Should print True
print(my_reverse(my_list))  # Should print [5, 4, 3, 2, 2, 1]
print(my_index(my_list, 3))  # Should print 3
